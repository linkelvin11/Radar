...
%  This version has been replaced by one that uses the marcumq in the
%  MATLAB Signal Processing Toolbox as of 6/8/2010
...
if ( Swerling_case == 0  | Swerling_case == 5 )
	...
	for r=1:R
        for c=1:C
            ...
            P(r,c) = marcum(A(r,c),B(r,c),0.01) + exp(-Trc-NSNRrc) * g ;
        end
    end
